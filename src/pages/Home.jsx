...
//               <button onClick={handleOpenAssignTask}>Assign Task</button>
//             </div>
//           </div>
//           <TaskList />
        ...
        <>
          <div className='navb'>
            ...
            <div className='btn'>
              ...
              <button style={{position:"absolute", bottom:"3.5vh",right:"3.5vh",  width: "5vw",
  height: "5vw",cursor:"pointer"}} onClick={handleOpenAssignTask}>+</button>
            </div>
          </div>
          <TaskList />
          {isAssignTaskOpen && <AssignTask onClose={handleCloseAssignTask} />}
